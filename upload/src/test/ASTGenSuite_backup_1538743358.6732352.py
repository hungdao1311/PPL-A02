...
Procedure main();
Begin
    S := "Hey your best friend";
    Write(S);

End
        """
        expect = str(Program([VarDecl(Id(r'S'),StringType()),FuncDecl(Id(r'main'),[],[],[Assign(Id(r'S'),StringLiteral(r'Hey your best friend')),CallStmt(Id(r'Write'),[Id(r'S')])],VoidType())]))
